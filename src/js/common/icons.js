define([
	...
	return {
		SearchIcon: () => (
			<svg className="search icon" width="13px" height="13px" viewBox="0 0 512 512">
		...
		ClearIcon: () => (
			<svg className="clear icon" width="10" height="16" viewBox="0 0 640 1024">
		...
		OptionsIcon: () => (
			<svg className="options icon" width="16" height="16" viewBox="0 0 14 16">
